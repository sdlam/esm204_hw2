...
2) calculate the total cost of meeting the target using that approach
The total cost of the policy is the same as for the tax because according to the equalmarginal principle, the districts will settle on the least coast way to achieve the reduction amount, which is where we set the tax. 
This is 255 * 158.355 * .05 = $2019.03
...
4) There is no tax revenue generated because there is no tax. 
