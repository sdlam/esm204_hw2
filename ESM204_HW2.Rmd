...
```
  ...
  Mojave: 158.355/3.8 * 158.36 * 0.05 * 0.5 = 329.9618
  
  Antelope: 158.355/2.86 * 158.36 * 0.05 * 0.5 = 438.4108
  ...
  **2) calculate the total cost of meeting the target using that approach**
  ...
  This is 455 * 282.555 * .5 = $64,281.26

  **3) calculate the cost to each district**
  
  This is also the same as the costs under the tax. 
  
  Kern: 158.355/2.29 * 158.36 * 0.5 = 547.5349
