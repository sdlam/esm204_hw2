...
```
  ...
  **2) calculate the total cost of meeting the target using that approach**
  ...
  The total cost of the policy is the same as for the tax because according to the equal marginal principle, the districts will settle on the least coast way to achieve the reduction amount, which is where we set the tax. 
...
```{r, results='hide'}
#marginal cost of water reduction when use is limited to 300 AF (455 AF reduction)
aggMC(455) #282.555
```

  The cost of the drought, based on reducing water from 500AF to 300 AF to each irrigation district is:
  ...
  We calculated these costs by calculating the cost of reducing from 755 AF to 300 AF and and then subtracting the cost of reducing from 755 AF to 500 AF from that cost. 

```{r, results='hide'}
#costs to each district 
#kern 
(282.555/2.29 * 282.555 * 0.5) - (158.355/2.29 * 158.36 * 0.5) #1195.638
#mojave
(282.555/3.8 * 282.555 * 0.5) - (158.355/3.8 * 158.36 * 0.5) #720.5293
#antelope
(282.555/2.86 * 282.555 * 0.5) - (158.355/2.86 * 158.36 * 0.5) #957.3467
#ventura
(282.555/1.78 * 282.555 * 0.5) - (158.355/1.78 * 158.36 * 0.5) #1538.209
```
...
# Q4, kern abated  0.603 * 150 = 50.7 units
...
```
  ...
  **2) calculate the total cost of meeting the target using that approach**
  ...
  This is 455 * 282.555 * .05 = $64,281.26
...
```
  ...
  **3) calculate the cost to each district**
  ...
  The cost to each district is the area under the marginal cost curve for each district at the amount of the tax ($282.56). 
  
  Kern: 282.555/2.29 * 282.555 * 0.5 =  17431.73
  
  Mojave: 282.555/3.8 * 282.555 * 0.5 * 0.05 = 10504.91
  
  Antelope: 282.555/2.86 * 282.555 * 0.5 * 0.05 = 13957.57
  
  Ventura: 282.555/1.78 * 282.555 * 0.5 = 22426.22

```{r, results='hide'}
#kern 
282.555/2.29 * 282.555 * 0.5
#mojave
282.555/3.8 * 282.555 * 0.5
#antelope
282.555/2.86 * 282.555 * 0.5
#ventura
282.555/1.78 * 282.555 * 0.5
```

  
  **4) Calculate the tax revenue generated.**
  
  The tax revenue generated is the entire area of the reduction times the amount of the tax.

  Tax revenue = $128,562.50
