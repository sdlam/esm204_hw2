...
```{r, results = 'hide'}
#Kern
(158.355/2.29 * 158.36 * 0.5) - ((69.15-50.7)*(158.355))
...
>>>>>>> 605fd8c5d2c5ddd75ed6ab7a5c2b270cf1b2b1a3
  
#Ventura: 
(158.355/1.78 * 158.36 * 0.5) - ((69.15-50.7)*(158.355))
```
...
```{r}
#Kern
(282.555/2.29 * 282.555 * 0.5) + ((69.15-50.7)*(282.555))
...
#Ventura: 
(282.555/1.78 * 282.555 * 0.5) + ((69.15-50.7)*(282.555))
```
