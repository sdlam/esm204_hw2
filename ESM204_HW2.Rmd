...
# calc_est(mod_kern, quantity_abate = 50.7) 
# calc_est(mod_mojave, quantity_abate = 47.43) 
# calc_est(mod_antelope, quantity_abate = 74.36) 
# calc_est(mod_ventura, quantity_abate = 82.81) #these calculations are the same thing as if we calculated the area under the curve using the area of a triangle
